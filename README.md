...
- **State Persistence**: Positions, scale factors, custom notes, timezones, and visibility states automatically save to `~/.config/quickshell/widget_settings.json`.
...
- **WorldClockWidget (`WorldClockWidget.qml`)**: Multi-city timezone hub with solar day/night indicators, double-click theme switching (5 palettes), and custom UTC offset addition.
